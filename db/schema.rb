...
ActiveRecord::Schema[8.0].define(version: 2025_07_04_114200) do
  ...
  create_table "stamp_cards", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["date"], name: "index_stamp_cards_on_date"
    t.index ["stamped_at"], name: "index_stamp_cards_on_stamped_at"
    t.index ["user_id", "date"], name: "index_stamp_cards_on_user_id_and_date", unique: true
